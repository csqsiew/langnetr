...
## The toedgelist function  

This function returns a dataframe of the *labelled* edgelist of the language network (the standard `as_edgelist` function in `igraph` returns an edgelist with node IDs).

```{r}
words.net.edgelist <- langnetr::toedgelist(words.net.labels)

head(words.net.edgelist)
```
